        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-gray-800 dark:text-white placeholder:text-gray-400"
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a href="#" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 hover:underline transition-colors">
                نسيت كلمة المرور؟
              </a>
            </div>
            ...
            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
              ليس لديك حساب؟{' '}
              <a href="#" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium hover:underline transition-colors">
                إنشاء حساب جديد
              </a>
            </p>
          </form>
