        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              />
              {errors.username && (
                <p className="text-sm text-red-500 flex items-center gap-1 mt-1">{errors.username}</p>
              )}
            </div>
            ...
            <div className="space-y-1">
              ...
              />
              {errors.email && (
                <p className="text-sm text-red-500 flex items-center gap-1 mt-1">{errors.email}</p>
              )}
            </div>
            ...
            <div className="space-y-1">
              ...
              {errors.password && (
                <p className="text-sm text-red-500 flex items-center gap-1 mt-1">{errors.password}</p>
              )}
            </div>
            ...
            <div className="space-y-1">
              ...
              {errors.confirm_password && (
                <p className="text-sm text-red-500 flex items-center gap-1 mt-1">{errors.confirm_password}</p>
              )}
            </div>
