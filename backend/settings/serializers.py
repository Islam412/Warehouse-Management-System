...
class CompanySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'address', 'address_ar', 'city', 'city_ar', 
            'state', 'state_ar', 'country', 'country_ar', 
            'postal_code',
...
class BranchCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'opening_time', 'closing_time',
            'is_24_hours', 'weekend_days',
            'is_active', 'is_main', 'manager'
        ]
        read_only_fields = ['id', 'code']


# ============================================
# StoreSettings Serializers
# ============================================
...
class StoreSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'allow_negative_stock', 'enable_batch_tracking', 
...
class SocialLinkSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SocialLink
        fields = [
            'id', 'company', 'platform', 'platform_ar', 
            'icon', 'url', 'is_active', 'order'
        ]
        read_only_fields = ['id']
...
class PaymentMethodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PaymentMethod
        fields = [
            'id', 'company', 'name', 'name_ar', 
            'icon', 'is_active', 'is_default', 'order'
        ]
        read_only_fields = ['id']


# ============================================
# ShippingMethod Serializers
# ============================================
...
class ShippingMethodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'company', 'name', 'name_ar', 
            'description', 'cost', 'estimated_days', 
